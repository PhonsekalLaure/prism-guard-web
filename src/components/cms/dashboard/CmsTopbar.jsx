  ...
  return (
    <header style={{ background: '#fff', padding: '1.2rem 1.5rem', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', position: 'sticky', top: 0, zIndex: 10 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1rem' }}>
        ...
        <button className="cms-dashboard-report-btn" style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', background: '#093269', color: '#fff', border: 'none', borderRadius: '8px', padding: '0.55rem 1.1rem', fontSize: '0.82rem', fontWeight: 600, cursor: 'pointer', fontFamily: 'Poppins, sans-serif' }}>
          <FaDownload />
          Download Reports
        </button>
      </div>
